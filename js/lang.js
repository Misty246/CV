...
const translations = {
  fr: {
    ...
    experience_satair_date: "Juin-Août 2026",
    experience_satair_title: "Stagiaire Supply-Officer AOG",
    experience_satair_description: "Priorisation et logistique de crise pour pièces de rechange critiques.",
    experience_satair_more: "Stage réalisé en Allemagne, au sein de l'équipe AOG (Aircraft On Ground) de Satair, filiale d'Airbus spécialisée dans la fourniture de pièces de rechange pour l'aviation.<br><br>• <strong>Gestion des urgences AOG :</strong> traitement prioritaire des demandes de pièces de rechange critiques pour minimiser l'immobilisation des avions au sol.<br><br>• <strong>Pilotage Supply Chain : </strong> coordination en temps réel avec les fournisseurs, la logistique et les compagnies aériennes.<br><br>• <strong>Résolution de crise : </strong> recherche de solutions alternatives en flux tendu sous contrainte d'aéronef bloqué.",
    ...
    experience_ffhm_more: "Responsable de la communication et des démarches stratégiques.<br><br> En charge de la visibilité et du développement de la structure, incluant : <br><br>• La création d’un site web <br><br>• La recherche de sponsors <br><br>• La mise en œuvre d’actions visant à renforcer la cohésion de la ligue entre les clubs.",
    ...
    experience_airbus_more: "• <strong>Analyse de Données & Pilotage SAP : </strong> Extraction de données ERP et suivi des KPI opérationnels.<br><br>• <strong>Automatisation & Digitalisation : </strong> Suppression des tâches répétitives via scripts et outils digitaux.<br><br>• <strong>Ingénierie d'Outils Décisionnels : </strong> Développement d'outils pour soutenir la prise de décision.<br><br>• <strong>Recherche & Développement Opérationnel : </strong> Identifier et mettre en œuvre des améliorations continues.<br><br>• <strong>Optimisation des Processus (Lean Management) : </strong> Cartographie VSM, réduction des goulots et des gaspillages.<br><br>• <strong>Expertise Métier \"Back-up Supply\" : </strong> Pilotage relais en cas de crise ou pic pour garantir la continuité de service.",
  ...
  en: {
    ...
    experience_satair_date: "June-August 2026",
    experience_satair_title: "Supply-Officer AOG Trainee",
    experience_satair_description: "Prioritization and crisis logistics for critical spare parts.",
    experience_satair_more: "Internship in Germany, within the AOG (Aircraft On Ground) team of Satair, a subsidiary of Airbus specializing in the supply of spare parts for aviation.<br><br>• <strong>AOG Emergency Management :</strong> priority handling of critical spare parts requests to minimize aircraft downtime.<br><br>• <strong>Supply Chain Management : </strong> real-time coordination with suppliers, logistics, and airlines.<br><br>• <strong>Crisis Resolution : </strong> search for alternative solutions under tight deadlines with grounded aircraft.",
    ...
    experience_ffhm_more: "Responsible for communication and strategic approaches.<br><br> In charge of the visibility and development of the structure, including: <br><br>• Creating a website <br><br>• Searching for sponsors <br><br>• Implementing actions to strengthen the cohesion of the league between clubs.",
    ...
    experience_airbus_more: "• <strong>Data Analysis & SAP Management : </strong> ERP data extraction and monitoring of operational KPIs.<br><br>• <strong>Automation & Digitalization : </strong> Elimination of repetitive tasks via scripts and digital tools.<br><br>• <strong>Decision-Making Tools Engineering : </strong> Development of tools to support decision-making.<br><br>• <strong>Operational Research & Development : </strong> Identify and implement continuous improvements.<br><br>• <strong>Process Optimization (Lean Management) : </strong> VSM mapping, reduction of bottlenecks and waste.<br><br>• <strong>\"Back-up Supply\" Business Expertise : </strong> Relay management in case of crisis or peak to ensure business continuity.",
